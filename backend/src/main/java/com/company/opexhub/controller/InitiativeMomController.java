...
//             InitiativeMomDTO mom = momService.createMom(initiativeId, request.getContent(), principal.getName());
//             return ResponseEntity.ok(mom);
//         } catch (RuntimeException e) {
...
//             InitiativeMomDTO mom = momService.updateMom(momId, initiativeId, request.getContent(), principal.getName());
//             return ResponseEntity.ok(mom);
//         } catch (RuntimeException e) {
//             return ResponseEntity.badRequest().body(new ApiResponse(false, e.getMessage()));
//         } catch (Exception e) {
...
//         @javax.validation.constraints.NotBlank(message = "Content is required")
